...
def get_emotion_values(image_url):
	...
	data = { "url": image_url}
	headers = {"Content-Type": "application/json", "Ocp-Apim-Subscription-Key": "cd990cb0d7e944c583a94a1b70ea3844"}
	r = requests.post(url, params = None, data = json.dumps(data), headers = headers)
	return r.text

print get_emotion_values("http://snappa.static.pressassociation.io/assets/2015/06/26090251/1435305770-36a7c3951a2bb484f033814ee652156a-600x398.jpg")
